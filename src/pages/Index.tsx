  ...
  return (
    <div className="rounded-2xl ring-1 ring-slate-200 bg-white shadow transition">
      ...
      <div
        ...
        className={`px-6 pb-5 text-slate-700 text-base transition-all duration-300 ease-in-out ${
    ...
    <>
            ...
            <div className="flex-1 relative">
              <div className="relative max-w-lg mx-auto">
                ...
                <video
                  ...
                  loop
                  playsInline
                  aria-label="Students learning together in an engaging educational environment"
                />
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-[1200px] px-6 py-16 bg-[#F7FAFD] hidden">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* 1. Annual Partners */}
          <div
            className="bg-[#F9FAFB] rounded-xl p-6 shadow-sm flex items-center space-x-4"
            aria-label="950 annual partners"
          >
          ...
          <div
            className="bg-[#F9FAFB] rounded-xl p-6 shadow-sm flex items-center space-x-4"
            aria-label="58k completed projects"
          >
            <div className="w-14 h-14 bg-blue-50 rounded-lg flex items-center justify-center">
              <TrendingUp
                className="w-6 h-6 text-blue-600"
          ...
          <div
            className="bg-[#F9FAFB] rounded-xl p-6 shadow-sm flex items-center space-x-4"
            aria-label="500 happy customers"
          >
            <div className="w-14 h-14 bg-blue-50 rounded-lg flex items-center justify-center">
              <CheckCircle
                className="w-6 h-6 text-blue-600"
      ...
      >
        <div className="mx-auto max-w-[1200px] px-6 py-20">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <h2
              id="services-title"
              className="mt-2 text-2xl md:text-3xl font-bold text-slate-900"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center rounded-3xl bg-white p-8 shadow-lg ring-1 ring-slate-100 hover:shadow-xl transition h-full">
              <div
                className="mx-auto mb-4 h-12 w-12 grid place-content-center rounded-xl bg-[#EEF4FF] text-[#2563EB]"
                aria-hidden="true"
              >
                {/* icon: person */}
                <svg
              ...
              <p className="mt-1 text-slate-600">
                Personalized sessions, 30 and 60 minutes. ESL included.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center rounded-3xl bg-white p-8 shadow-lg ring-1 ring-slate-100 hover:shadow-xl transition h-full">
              ...
              >
                ...
                >
                  ...
                  <path d="M2 20a8 8 0 0116 0" />
                  <path d="M22 20a6 6 0 00-9-5" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-slate-900">
                Small Group Sessions
              ...
              <p className="mt-1 text-slate-600">
                Collaborative learning for 5–10 students (2 credits / 1 hr
                class).
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center rounded-3xl bg-white p-8 shadow-lg ring-1 ring-slate-100 hover:shadow-xl transition h-full">
              ...
              >
                ...
                <svg
                  ...
                  strokeWidth="2"
                >
                  <path d="M8 8a4 4 0 118 0v8a4 4 0 11-8 0z" />
                  <path d="M12 2v2M6 6l-2-2M18 6l2-2" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-slate-900">
                Executive Function Coaching
              ...
              <p className="mt-1 text-slate-600">
                Time management, planning, and focus.
              </p>
            </div>
          </div>
          ...
          <div className="mt-10 text-center">
            <a
              href="/pricing"
              className="inline-flex items-center justify-center h-11 px-6 rounded-full bg-[#2563EB] text-white font-medium hover:bg-[#1d4ed8]"
            >
              See Pricing & Credits
            </a>
          </div>
        ...
        <div className="container">
          ...
          <div className="text-center mt-8">
            <p className="text-sm text-blueGray-400">
              ...
              Credits roll over for up to 2 months (see FAQ for details).
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1200px] px-6 py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start mb-12">
            ...
            <p className="text-slate-600 leading-relaxed">
              We provide personalized, high-quality tutoring for K–12 students
              and beyond. Sessions are flexible, engaging, and designed to boost
          ...
          <div className="rounded-3xl bg-[#2563EB] text-white shadow-xl p-8 md:p-12 flex flex-col items-center text-center relative overflow-hidden">
            ...
            <div className="transition-all duration-700 ease-out opacity-100 translate-y-0">
              ...
              <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
                At Smart Brain TLC’s Enroll One, Empower Two initiative, every
                enrollment funds an opportunity for another child. Whether
                you’re an individual, business, school, or foundation, we’ll
                customize a partnership that maximizes your impact.
              </p>
              <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-8">
                <article className="h-full rounded-2xl ring-1 ring-white/20 bg-white/5 backdrop-blur-sm p-6 md:p-7 shadow-sm hover:shadow-md hover:ring-white/40 transition">
                  <div className="flex flex-col items-center text-center">
                    <div
                      className="mb-4 h-12 w-12 rounded-full bg-white/15 text-white grid place-content-center"
                      aria-hidden="true"
                    >
                      {/* Heart icon */}
                      <svg
                    ...
                    <h3 className="text-white font-semibold text-lg">
                      Individuals &amp; Monthly Sponsorships
                    </h3>
                    <p className="mt-2 text-white/90">
                      Empower a child, lesson by lesson. One-time or monthly
                      sponsorships with progress updates and a personal
                      thank-you.
                    </p>
                  </div>
                </article>
                <article className="h-full rounded-2xl ring-1 ring-white/20 bg-white/5 backdrop-blur-sm p-6 md:p-7 shadow-sm hover:shadow-md hover:ring-white/40 transition">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="mt-2 text-white/90">
                      CSR-aligned packages and reporting. Showcase your
                      commitment to education with visible impact.
                    </p>
                  </div>
                </article>
                <article className="h-full rounded-2xl ring-1 ring-white/20 bg-white/5 backdrop-blur-sm p-6 md:p-7 shadow-sm hover:shadow-md hover:ring-white/40 transition">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="mt-2 text-white/90">
                      Bulk credits for students. Principals assign credits;
                      receive usage and impact reports.
                    </p>
                  </div>
                </article>
              </div>
              <div className="flex flex-col sm:flex-row gap-4 justify-center mt-4">
                <a
                  href="/sponsors"
                  className="inline-flex h-11 px-6 items-center justify-center rounded-full bg-white text-[#2563EB] font-semibold hover:bg-slate-100 transition"
                >
                  Become a Partner Today
                </a>
                <a
                  href="/contact?type=partner"
                  className="inline-flex h-11 px-6 items-center justify-center rounded-full border border-white text-white font-semibold hover:bg-white/10 transition"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start mb-12">
            ...
            <Reveal delay={250}>
              <p className="text-slate-500 leading-8">
                Teach with purpose. Enjoy flexible hours and competitive pay
                while helping under-resourced learners succeed.
              </p>
            </Reveal>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            ...
            <Reveal delay={200}>
              <article className="relative pt-16 p-10 text-center rounded-[28px] bg-white shadow-xl ring-1 ring-slate-100 hover:shadow-2xl transition">
                ...
                <p className="text-slate-500 leading-relaxed max-w-[36ch] mx-auto">
                  Make a real impact each session with learners who need your
                  expertise.
                </p>
              </article>
            </Reveal>
            ...
            <Reveal delay={350}>
              <article className="relative pt-16 p-10 text-center rounded-[28px] bg-white shadow-xl ring-1 ring-slate-100 hover:shadow-2xl transition">
                ...
                <p className="text-slate-500 leading-relaxed max-w-[36ch] mx-auto">
                  Set a schedule that works for you—weekdays, weekends, or
                  evenings.
                </p>
              </article>
            </Reveal>
            ...
            <Reveal delay={500}>
              <article className="relative pt-16 p-10 text-center rounded-[28px] bg-white shadow-xl ring-1 ring-slate-100 hover:shadow-2xl transition">
                ...
                <p className="text-slate-500 leading-relaxed max-w-[36ch] mx-auto">
                  Get paid reliably for every completed session with clear
                  reporting.
                </p>
              </article>
            </Reveal>
        ...
        <div className="max-w-[1000px] mx-auto px-6">
          <div className="mb-10 text-center">
            ...
            <p className="text-slate-500 text-lg">
              Quick answers about credits, scheduling, and sponsorships.
            </p>
          </div>
          {/* Accordion */}
          <div className="space-y-4">
              ...
              <div className="px-5 md:px-6 pt-0 pb-0 group-open:pb-5">
                <div className="grid overflow-hidden transition-[grid-template-rows] duration-300 ease-out grid-rows-[0fr] group-open:grid-rows-[1fr]">
                  <div className="min-h-0">
                    <p className="text-slate-600 leading-relaxed">
                      One credit equals 30 minutes of tutoring. Sessions can be
                      30 or 60 minutes using 1 or 2 credits.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <details className="group rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm transition open:shadow-md">
              ...
              <div className="px-5 md:px-6 pt-0 pb-0 group-open:pb-5">
                <div className="grid overflow-hidden transition-[grid-template-rows] duration-300 ease-out grid-rows-[0fr] group-open:grid-rows-[1fr]">
                  <div className="min-h-0">
                    <p className="text-slate-600 leading-relaxed">
                      Unused credits roll over for up to 2 months. See our full
                      FAQ for details.
                    </p>
                  </div>
                </div>
            ...
            <details className="group rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm transition open:shadow-md">
              <summary className="flex w-full items-center justify-between cursor-pointer px-5 py-4 md:px-6 md:py-5 text-left select-none">
                <span className="font-medium text-slate-900">
                  How do I book and schedule sessions?
                </span>
                <svg
                  className="h-5 w-5 shrink-0 text-slate-500 transition-transform group-open:rotate-180"
                  viewBox="0 0 24 24"
              ...
              <div className="px-5 md:px-6 pt-0 pb-0 group-open:pb-5">
                <div className="grid overflow-hidden transition-[grid-template-rows] duration-300 ease-out grid-rows-[0fr] group-open:grid-rows-[1fr]">
                  <div className="min-h-0">
                    <p className="text-slate-600 leading-relaxed">
                      Choose a tutor and time that works for you; you’ll confirm
                      using available credits. Rescheduling is flexible within
                      the booking window.
                    </p>
                  </div>
                </div>
            ...
            <details className="group rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm transition open:shadow-md">
              <summary className="flex w-full items-center justify-between cursor-pointer px-5 py-4 md:px-6 md:py-5 text-left select-none">
                <span className="font-medium text-slate-900">
                  Can I sponsor a student or partner with you?
                </span>
                <svg
                  className="h-5 w-5 shrink-0 text-slate-500 transition-transform group-open:rotate-180"
                  viewBox="0 0 24 24"
              ...
              <div className="px-5 md:px-6 pt-0 pb-0 group-open:pb-5">
                <div className="grid overflow-hidden transition-[grid-template-rows] duration-300 ease-out grid-rows-[0fr] group-open:grid-rows-[1fr]">
                  <div className="min-h-0">
                    <p className="text-slate-600 leading-relaxed">
                      Yes—individuals and organizations can sponsor learners or
                      partner with us. Visit the Sponsors page to get started.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/pricing"
              className="inline-flex h-11 px-6 items-center justify-center rounded-full border border-slate-300 bg-white text-slate-700 hover:bg-slate-50 transition"
            >
              See Pricing &amp; Credits
            </a>
          </div>
